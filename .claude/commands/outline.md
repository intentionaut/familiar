---
description: Familiar: Propose three structures for the piece; the writer picks
---
Run the Familiar **outline** stage. Familiar lives at `{{FAMILIAR_HOME}}`.
...
3. Read `{{FAMILIAR_HOME}}/prompts/outline.md` and follow every instruction in it exactly. It names the knowledge files you must read first.
