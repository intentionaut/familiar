...
`knowledge/` is where Familiar keeps what it knows about how you write. Four
...
Fill in `positioning.md` and `voice-guide.md` before the first piece. The other
two can grow as you go. The second time you correct the same thing by hand,
