---
description: Familiar: Interview the writer one question at a time until the idea is sharp
---
Run the Familiar **interview** stage. Familiar lives at `{{FAMILIAR_HOME}}`.
...
3. Read `{{FAMILIAR_HOME}}/prompts/interview.md` and follow every instruction in it exactly. It names the knowledge files you must read first.
